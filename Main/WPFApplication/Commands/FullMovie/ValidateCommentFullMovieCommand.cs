...
{
    public class ValidateCommentFullMovieCommand : CommandBase
    {
        ...
        #region BUILDERS
        public ValidateCommentFullMovieCommand(FullMovieViewModel fullMovieViewModel)
        {
        ...
        {
            if(parameter is int)
                FullMovieViewModel.InvalidateOrValidateComment((int)parameter, true);
        }
        #endregion
    }
}
