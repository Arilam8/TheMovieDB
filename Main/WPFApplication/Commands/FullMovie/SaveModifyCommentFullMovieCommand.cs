...
{
    public class SaveModifyCommentFullMovieCommand : CommandBase
    {
        ...
        #region BUILDERS
        public SaveModifyCommentFullMovieCommand(FullMovieViewModel fullMovieViewModel)
        {
        ...
        {
            if(parameter is int)
                FullMovieViewModel.SaveModifyComment((int)parameter);
        }
        #endregion
    }
}
